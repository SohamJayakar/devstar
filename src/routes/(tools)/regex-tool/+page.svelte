<script>
	...
	function applyPattern(event) {
	  ...
	  if (regexPatterns[selectedPattern]) {
		regex.set(regexPatterns[selectedPattern].source);
	  }
	}
  </script>
	  ...
	  <div class="flex-1">
		...
		<div class="flex items-center">
		  ...
		  <div class="relative ml-4">
			...
			{#if showDropdown}
			  <div class="absolute right-0 mt-2 md:left-0 md:right-auto w-30 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded shadow-lg max-h-40 overflow-y-auto z-10">
